...
培养方案：http://jwc.upc.edu.cn/492/list.htm
有纸质书，各学院群也会发布

教务处发布的2023-2024-2学期选课的通知：https://jwc.upc.edu.cn/2024/0108/c18518a420507/page.htm
</details>
...
这种转专业方式的主要难点在于学分绩（面试一般只是走流程，主要还是看学分绩），热门专业的选拔转接收人数容易达到上限，实际上需要比上面的基本要求更高的学分绩。但大部分学生到了大学就开摆，所以其实大部分专业（在2023年，甚至包括计算机学院的全部专业）并不会达到接收上限，只要达到基本要求就能转。**建议先以学优转为目标，如果失败了再走选课转。注意，这里的各类要求指的是大一上的成绩。**

#### 特长转
历年特长转专业学生接收比例大约占总选拔转专业人数的 10% 左右，具体名额由接收专业制定，具有一定的不确定性。一般来说，高中或大一有竞赛经历（如acm俱乐部）的比较有机会。特长转专业也需要进行面试选拔，但是没有硬性的成绩要求，学分绩未达到要求但对自己的能力有足够自信的同学可以尝试。
#### 学困转
...
可见选课转的条件非常宽松，只需要退掉只有原专业有的课、选上目标专业的课，让相差学分小于等于10（少部分专业同时要求部分课程一定要修读，详情见附件1），即可转入。
...
8. 接上条目“冲抵”，简单来说，名字和学分都差不多的两门课可以互相冲抵，即学了A课相当于就学了B课。
9. 挂科的课程不算做已修读学分。
...
正选和补退选采用“先报名，后抽签”的选课模式，每个人在正选和补退选都**分别**拥有100积分，选课时可以投0到100，先看年级，年级高的优先选上，同年级的分高者得。
...
5. 课程编号一样的课就是一样的，能冲抵的课也可以看作一样的，也就是说假如有些课冲突了或者选不上可以考虑换成别的一样的课。

另外关于选课系统需要注意：

1. 选课系统包括本学期计划课程、其它学期的计划课程和外专业课程，本该找到但是找不到的课可能在别的栏目里。
2. 课程编号一样的课已经选上则无法再被搜索到。

#### 补退选
可以在这个环节选上别人退掉的课，退掉正选时应该退但是没有退的课，时间一般安排在下一学期开始前。该环节如果要选的课已经超出人数限制，那么需要投入大量积分，否则选中的概率很小。

#### 选退课申请表
若上述方法均未选到课，可在开课前两周之内尝试填写纸质选退课申请表到[教学运行科](#教学运行科)亲自办理选课。该方法对暂未成功转入的同学来说成功率较低。
<a name="选退课申请表"></a>
...
什么是免听？简单来说，免听是一种针对有冲突的课程的选课方式，由于不需要投积分，只需要和老师协商即可选上课，所以操作空间很大，一个学期最多可以免听四门课，也就是说光是通过免听理论上一个学期就能稳稳补十几个学分。
...
由上面的免听申请流程文档可知，简单来说办理免听的流程如下：

学校发布通知开放免听系统
1. 进入免听系统选上要申请免听的课。
2. 打印两份免听单。
3. 与老师协商签字后送去对应开课学院[教学办](#教学办)签字盖章，一份教学办保存一份老师保存。
...
2. 一般高学分可以冲抵低学分，必修可以冲抵限选，限选可以冲抵公选，反之则不行。
   
对于要转专业的你来说，你需要知道：
1. 学分冲抵系统只包括本专业课程，所以要先转过去再冲抵。
2. 选课转申请的时候，可以冲抵的课程不算作相差的10学分内，也就是说如果实在选不上课程编号一样的课，选能冲抵的课也行。
3. 有些课在一些专业分2-1和2-2，在另一些专业不分，比如计科的离散数学分“离散数学2-1”和“离散数学2-2”，而软件的离散数学只有“离散数学”，但是软件的“离散数学”学分比计科的“离散数学2-2”要高，所以可以同时选计科的“离散数学2-1”和软件的“离散数学”，然后用后者冲抵计科的离散数学2-2，达到在一个学期内补上2-1和2-2两门课学分的目的。
4. 编号一样的课不需要冲抵，编号一样的课就是一样的课相当于已经学了。
5. 在计算机学院计算保研成绩时有如下规定：低学分课程冲抵高学分课程的成绩按比例折扣，比如用4学分成绩90的课程冲抵5学分，保研计算成绩时算作90*4/5=72分，限选冲抵必修算作0分。
   
如果你想得到具体能不能冲抵的准确答复，可以前往对应学院 [教学办](#教学办)或联系系主任咨询。
